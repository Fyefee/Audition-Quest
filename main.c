...
int mission_on = 0, easy_1_mission = 0, easy_2_mission = 0, easy = 0, easy_1 = 0, easy_2 = 0, easy_bg_count = 0, character_count = 0, monster_count = 0;
...
int easy_1_idle = 0, easy_2_idle = 0, attack_on = 0, cha_idle_on = 0;
